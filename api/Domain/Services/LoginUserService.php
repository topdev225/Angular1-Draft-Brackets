...
class LoginUserService {
  ...
  public function GetCurrentUser(Request $request) {
	//empty too much below more reliable
	
    return $this->GetUserFromHeaderToken($request);
  }
  ...
  public function CreateUnverifiedNewUser(LoginUser $user) {
    ...
    try {
      ...
      $message->subject = "Draft Brackets: Please verify your email address";
      $message->is_html = true;
      $verificationLink = $this->_CreateEmailVerificationLink($user);
      $message->body = sprintf("Hi $user->name, <br/><br/>\n\n 

        Thanks for joining the Draft Brackets community! <br/><br/>\n\n 

        An account was created using your email <strong>%s</strong> but before you can start playing Draft Brackets, this email address must be verified so your Draft Brackets account can be activated. Click the link below to activate your account! <br/><br/>\n\n
  ...
  public function BeginForgottenPasswordProcess(LoginUser $user) {
    ...
    try {
      ...
      $message->subject = "DraftBrackets: Reset Password Request";
      $message->is_html = true;
  ...
  public function UpdateUserProfile(Request $request) {
    ...
    try{
      ...
      if($sendEmail) {
        ...
        $message->subject = "DraftBrackets: Verify your email address";
        $message->is_html = true;
        $verificationLink = $this->_CreateEmailVerificationLink($user);
