...
class ManagerService {
  ...
  public function CreateManyManagers($draft_id,$contest_id, $managersArray) {
    $response = new PhpDraftResponse();

    try {
      $managers = $this->app['phpdraft.ManagerRepository']->CreateMany($draft_id,$contest_id, $managersArray);
