...
class PickService {
  ...
  public function AddPick(Draft $draft, Pick $pick, Request $request) {
    $response = new PhpDraftResponse();
    ...
    try {
      ...
      //Save the pick
      $pick = $this->app['phpdraft.PickRepository']->AddPick($pick, $draft, $request);
      //Get the next pick
  ...
  public function UpdatePick(Draft $draft, Pick $pick, Request $request) {
  ...
  public function AlreadyDrafted($draft_id, $team,$request) {
    $response = new PhpDraftResponse();

    try {
      $response->matches = $this->app['phpdraft.PickRepository']->SearchAlreadyDrafted($draft_id, $team,$request);
